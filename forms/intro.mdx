...
[Alta recém-nascido com sífilis](https://drive.google.com/file/d/13fzQXTGrdJC26Dr-PGKlE6_hJWO9xIlI/view?usp=drive_link) and create a new Docusaurus site:
...
For existing v1 users that are seeking to upgrade to v2+, you can follow our .
